...
class Csv : public Importer {
  ...
  private:
    std::string get_str(const std::vector<std::string> &row, const std::string &header);
    int         get_int(const std::vector<std::string> &row, const std::string &header);
