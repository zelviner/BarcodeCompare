...
bool InnerBox::compare(QString &error) {
    ...
    QString start_iccid      = inner_box_info_->start_iccid.mid(inner_box_start_check_num, inner_box_end_check_num - inner_box_start_check_num);
    QString end_iccid        = inner_box_info_->end_iccid.mid(inner_box_start_check_num, inner_box_end_check_num - inner_box_start_check_num);
    QString start_card_iccid = inner_box_info_->start_card_iccid.mid(card_start_check_num, card_end_check_num - card_start_check_num);
    QString end_card_iccid   = inner_box_info_->end_card_iccid.mid(card_start_check_num, card_end_check_num - card_start_check_num);
